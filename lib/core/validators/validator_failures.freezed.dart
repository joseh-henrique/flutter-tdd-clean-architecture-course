...
part of 'validator_failures.dart';
...
class _$ValueFailureTearOff {
  ...
  InvalidIntNumber<T> invalidIntNumber<T>({@required T failedValue}) {
    return InvalidIntNumber<T>(
      failedValue: failedValue,
    );
  }
...
mixin _$ValueFailure<T> {
  ...
  Result when<Result extends Object>({
    ...
    @required Result invalidIntNumber(T failedValue),
  ...
  Result maybeWhen<Result extends Object>({
    ...
    Result invalidIntNumber(T failedValue),
  ...
  Result map<Result extends Object>({
    ...
    @required Result invalidIntNumber(InvalidIntNumber<T> value),
  ...
  Result maybeMap<Result extends Object>({
    ...
    Result invalidIntNumber(InvalidIntNumber<T> value),
...
abstract class $InvalidIntNumberCopyWith<T, $Res>
    implements $ValueFailureCopyWith<T, $Res> {
  factory $InvalidIntNumberCopyWith(
          InvalidIntNumber<T> value, $Res Function(InvalidIntNumber<T>) then) =
      _$InvalidIntNumberCopyWithImpl<T, $Res>;
  @override
  $Res call({T failedValue});
}

class _$InvalidIntNumberCopyWithImpl<T, $Res>
    extends _$ValueFailureCopyWithImpl<T, $Res>
    implements $InvalidIntNumberCopyWith<T, $Res> {
  _$InvalidIntNumberCopyWithImpl(
      InvalidIntNumber<T> _value, $Res Function(InvalidIntNumber<T>) _then)
      : super(_value, (v) => _then(v as InvalidIntNumber<T>));

  @override
  InvalidIntNumber<T> get _value => super._value as InvalidIntNumber<T>;

  @override
  $Res call({
    Object failedValue = freezed,
  }) {
    return _then(InvalidIntNumber<T>(
      failedValue:
          failedValue == freezed ? _value.failedValue : failedValue as T,
    ));
  }
...
class _$InvalidIntNumber<T>
    with DiagnosticableTreeMixin
    implements InvalidIntNumber<T> {
  const _$InvalidIntNumber({@required this.failedValue})
      : assert(failedValue != null);
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ValueFailure<$T>.invalidIntNumber(failedValue: $failedValue)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'ValueFailure<$T>.invalidIntNumber'))
      ..add(DiagnosticsProperty('failedValue', failedValue));
  }
  ...
  @override
  $InvalidIntNumberCopyWith<T, InvalidIntNumber<T>> get copyWith =>
      _$InvalidIntNumberCopyWithImpl<T, InvalidIntNumber<T>>(this, _$identity);
  ...
  Result when<Result extends Object>({
    ...
    assert(shortPassword != null);
    assert(invalidPhotoUrl != null);
    return invalidIntNumber(failedValue);
  }
...
abstract class InvalidIntNumber<T> implements ValueFailure<T> {
  const factory InvalidIntNumber({@required T failedValue}) =
      _$InvalidIntNumber<T>;
